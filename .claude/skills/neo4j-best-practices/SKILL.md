...
description: "Neo4j knowledge graph best practices — SUPERSEDES versioning, group_id on every node, parameterized Cypher queries, security patterns. Use when working with Neo4j, graph queries, or Allura semantic memory."
---
...
await session.run(`
  ...
  SET v1:deprecated
`, { id, newSummary, groupId: 'allura-system' });
```
