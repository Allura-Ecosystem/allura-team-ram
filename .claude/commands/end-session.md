...
allowed-tools: ["read", "mcp__allura-brain__memory_add", "mcp__allura-brain__memory_search", "mcp__allura-brain__memory_list", "MCP_DOCKER_mcp-config-set", "MCP_DOCKER_mcp-add"]
