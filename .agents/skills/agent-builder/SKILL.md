...
- Agent naming: `{name}.md` in `.Codex/agents/` for Team RAM agents, or skill directory in `.Codex/skills/`
...
### Phase 5: Build
- Output agent definition to `.Codex/agents/` or `.Codex/skills/`
- Follow Team RAM conventions from `.Codex/rules/agent-routing.md`
...
- Agent definitions live in `.Codex/agents/*.md` with YAML frontmatter
...
- Agent routing follows `.Codex/rules/agent-routing.md`
