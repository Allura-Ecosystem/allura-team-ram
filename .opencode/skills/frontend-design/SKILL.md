...
| Gate | Check |
|------|-------|
| **Brand context** | Load `AGENTS.md` design tokens. Confirm active color set (allura-coral / primary / surface-subtle). |
...
- `AGENTS.md` — brand tokens, component library, WCAG rules
